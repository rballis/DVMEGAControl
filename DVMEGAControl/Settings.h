...
namespace DVMEGAControl {
	...
	public:
        ...
        void SetSettings(SettingsData* sd)
        {
            ...
            nmInterval->Text = gcnew String(std::to_string(sd->Interval).c_str());
            tbUser->Text = gcnew String(sd->User.c_str());
            tbPassword->Text = gcnew String(sd->Password.c_str());
            nmPort->Text = gcnew String(std::to_string(sd->Port).c_str());
        }
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            this->nmInterval = (gcnew System::Windows::Forms::NumericUpDown());
            this->groupBox2 = (gcnew System::Windows::Forms::GroupBox());
            this->nmPort = (gcnew System::Windows::Forms::NumericUpDown());
            this->groupBox1->SuspendLayout();
            (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->nmInterval))->BeginInit();
            ...
            // btnTest
            // 
            this->btnTest->Location = System::Drawing::Point(151, 72);
            ...
            this->label4->Location = System::Drawing::Point(169, 23);
            ...
            this->tbUser->Size = System::Drawing::Size(95, 20);
            ...
            this->tbPassword->Size = System::Drawing::Size(178, 20);
            ...
            this->tbWEBAdr->Size = System::Drawing::Size(119, 20);
            this->tbWEBAdr->TabIndex = 22;
            // 
            // label6
            // 
            this->label6->AutoSize = true;
            this->label6->Location = System::Drawing::Point(168, 22);
            ...
            // groupBox1
            // 
            this->groupBox1->Controls->Add(this->nmInterval);
            ...
            // nmInterval
            // 
            this->nmInterval->Location = System::Drawing::Point(205, 19);
            this->nmInterval->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 10, 0, 0, 0 });
            this->nmInterval->Name = L"nmInterval";
            this->nmInterval->Size = System::Drawing::Size(41, 20);
            this->nmInterval->TabIndex = 26;
            // 
            // groupBox2
            // 
            this->groupBox2->Controls->Add(this->nmPort);
            ...
            // nmPort
            // 
            this->nmPort->Location = System::Drawing::Point(205, 20);
            this->nmPort->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 999, 0, 0, 0 });
            this->nmPort->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
            this->nmPort->Name = L"nmPort";
            this->nmPort->Size = System::Drawing::Size(41, 20);
            this->nmPort->TabIndex = 22;
            this->nmPort->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
            // 
            // Settings
            // 
            ...
            (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->nmInterval))->EndInit();
